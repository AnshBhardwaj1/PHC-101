...
print("Maximum: ",max)
print("Minimum: ",min)
print("Average: ",avg)#Write a function which reads a one-dimensional array and the number of elements, and returns the following quantities: (i) Maximum (ii) Minimum and (iii) average.
n=int(input("Enter the number of elements: "))
array=[]
for i in range(n):
    array.append(int(input("Enter the element: ")))
